...
2. **GitHub Security Advisory**: Use [GitHub's private vulnerability reporting](https://github.com/lgzarturo/setup-claude-developer/security/advisories/new) (if enabled)
...
4. **Resolution**: Once fixed, we will notify you and publicly disclose the issue (with credit if desired)
...
1. **Review before execution**: Always review scripts before running them in your environment
2. **Use in isolated environments**: Test in a container or VM before production use
3. **Keep dependencies updated**: If the scripts install tools, ensure they are up to date
